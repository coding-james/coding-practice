...
namespace Sandbox.Cave
{
    internal class RunCave
    {
        public static void Run()
        {
            ...
            Carabiner petzlOval2023 = new Carabiner("Petzl OK", "Oval", "Silver", "01/02/2023", "New", 3, 11.66, "Inglesport");
            Carabiner petzlWilliam2023 = new Carabiner("Petzl William", "Pear", "Silver", "01/02/2023", "New", 5, 15.50, "Cotswold Outdoor");
            Console.WriteLine(petzlOval2023.Inventory());
            Console.WriteLine(petzlWilliam2023.PriceChange());
        }
