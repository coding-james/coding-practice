...
const { convertCtoF, reverseString, factorialize, findLongestWordLength, largestOfFour, confirmEnding } = require("../../../freeCodeCamp/JavaScriptAlgorithmsAndDataStructures/basic-algorithm-scripting");
const { repeatStringNumTimes, truncateString, findElement, booWho, titleCase, frankenSplice, bouncer, getIndexToIns, mutation, chunkArrayInGroups } = require("../../../freeCodeCamp/JavaScriptAlgorithmsAndDataStructures/basic-algorithm-scripting");
